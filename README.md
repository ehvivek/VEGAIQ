# 🏎️ PitMind — F1 Driver Psychological Analyzer

**"Understand the mind. Beyond the data."**

> The world's first public-facing F1 driver psychological analyzer — revealing the mental story inside the car that fans never get to see.

![Python](https://img.shields.io/badge/Python-3.10+-blue?logo=python)
![Streamlit](https://imbadge/Streamlit-1.35+-red?logo=streamlit)
![IBM Granite](https://img.shields.io/badge/IBM_Granite-3.1-blue?logo=ibm)
...
**PitMind** combines real F1 telemetry data, team radio analysis, synthetic biometric modeling, and IBM AI to publicly reveal the psychological story of a race, lap by lap. For the first time, fans can understand:
...
PitMind analyzes **Max Verstappen's complete Abu Dhabi GP 2024**, uncovering the critical **Lap 47 psychological crisis** triggered by Safety Car deployment, tyre degradation, and championship pressure.

---

## 🛠️ IBM Tools Used

| IBM Tool | Role in PitMind | Integration |
|----------|----------------|-------------|
...
### IBM Granite 3.1 Functions
1. **`analyze_lap()`** — Generates 4-sentence psychological profile per lap using stress scores, radio, and race events
...
All models trained on 2000 synthetically generated F1 lap records mirroring real race patterns.
...
| Reaction Time Delta | Cognitive load degradation model (ms vs baseline) |
...
| AI Brain | IBM Granite 3.1 via watsonx.ai |
| Dev Assistant | IBM Bob |
| Pipeline | Langflow |
| ML Models | scikit-learn (GBR, RF, Ridge) |
| F1 Data | FastF1 + OpenF1 API |
| Charts | Plotly |
...
<p align="center">
  <b>PitMind</b> · Powered by IBM Granite · Data: OpenF1 + FastF1<br>
